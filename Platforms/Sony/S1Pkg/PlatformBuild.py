...
class CommonPlatform():
    ...
    '''
    PackagesSupported = ("S1Pkg",)
    ArchSupported = ("ARM",)
    TargetsSupported = ("DEBUG", "RELEASE")
    Scopes = ('S1', 'gcc_ARM_linux', 'edk2-build')
...
class PlatformBuilder( UefiBuilder, BuildSettingsManager):
    ...
    def RetrieveCommandLineOptions(self, args):
        ...
        shell_environment.GetBuildVars().SetValue(
            "ACTIVE_PLATFORM", "S1Pkg/S1.dsc", "From CmdLine")
    ...
    def SetPlatformEnv(self):
        ...
        self.env.SetValue("PRODUCT_NAME", "S1", "Platform Hardcoded")
        self.env.SetValue("ACTIVE_PLATFORM", "S1Pkg/S1.dsc", "Platform Hardcoded")
